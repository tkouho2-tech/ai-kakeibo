...
def main():
    ...
    if st.session_state.get('logged_in', False):
        ...
        with st.sidebar:
            ...
            """, unsafe_allow_html=True)
            st.subheader("マイニィ [Ver 6.2.29]")
            st.write(f"🔑 ユーザー: **{st.session_state['username']}**")
            # --- プロフェッショナル診断ツール (Ver 6.2.29) ---
...
"""
            ...
            st.markdown("---")
            st.caption("マイニー [Ver 6.2.29] - 常に最新の技術であなたの家計管理をサポートします。")
        ...
        st.caption("マイニー Ver 6.2.29 - ユーザー: %s" % st.session_state['username'])
